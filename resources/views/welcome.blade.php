...
<body>
  ...
  <div class="items-top relative flex min-h-screen justify-center bg-gray-900 py-4 sm:items-center sm:pt-0">
    ...
    <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
      ...
      <div class="mt-8 overflow-hidden bg-gray-800 shadow sm:rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laravel.com/docs"
                  class="text-white underline">Documentation</a></div>
            </div>
          ...
          <div class="border-t border-gray-200 border-gray-700 p-6 md:border-t-0 md:border-l">
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="h-8 w-8 text-gray-500">
              ...
              <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laracasts.com"
                  class="text-white underline">Laracasts</a></div>
            </div>
          ...
          <div class="border-t border-gray-200 border-gray-700 p-6">
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="h-8 w-8 text-gray-500">
                <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div class="ml-4 text-lg font-semibold leading-7"><a href="https://laravel-news.com/"
                  class="text-white underline">Laravel News</a></div>
            </div>
          ...
          <div class="border-t border-gray-200 border-gray-700 p-6 md:border-l">
            <div class="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="h-8 w-8 text-gray-500">
                <path stroke-linecap="round" stroke-linejoin="round"
              ...
              <div class="ml-4 text-lg font-semibold leading-7 text-white">Vibrant
                Ecosystem</div>
            </div>
      ...
      <div class="mt-4 flex justify-center sm:items-center sm:justify-between">
        <div class="text-center text-sm text-gray-500 sm:text-left">
          <div class="flex items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="ml-4 -mt-px h-5 w-5 text-gray-400">
              <path stroke-linecap="round" stroke-linejoin="round"
